  ...
  return (
    <div className="about-container">
      ...
      <div className="about-interview">
        ...
        {/* <div className="about-interview-item">
          ...
          <div className="about-interview-answer">
            <div className="project-interview-answer">
              ...
              <p className="mt15">
                첫째, 다른 개발자가 작성한 코드와 외부 라이브러리, API를
                적용하는 데 어려움이 있었습니다.
              </p>
              <p className="mb15">
                특히 기존 코드의 구조가 낯설어 이해하는 데 시간이 걸렸습니다.
              </p>
              <p>둘째, 고객이 프로젝트 완료 일정에 대해 질문할 때입니다.</p>
              <p>
                기술적 제약이나 불확실성이 있을 때 확답을 드리기 힘들었고, 이
                과정에서 고객과의 소통이 중요하다는 것을 깨달았습니다.
              </p>
            </div>
          </div>
        </div> */}
        ...
        <div className="about-interview-item">
          <div className="about-interview-question mb15">
            Q. 프로젝트를 진행하면서 가장 중요하다고 생각한것은 무엇인가요??
          </div>
          <div className="about-interview-answer">
            <p className="mb15">
              프로젝트를 진행하면서 가장 중요하다고 생각하는 것은 팀원들과의
              소통입니다.
            </p>
            <p>
              소통이 원활하지 않을 경우 다툼이 발생하거나 페이지 수정이 반복되는
              문제를 경험했습니다.
            </p>
            <p>
              이런 상황을 겪은 후, 팀원들과의 소통을 더욱 강조하고 있습니다.
            </p>
          </div>
        </div>
        ...
        <div className="about-interview-item">
          ...
          <div className="about-interview-answer">
            <p className="mb15">
              자기계발은 주로 프로젝트를 진행하면서 느낀 부족한 부분을 보완하는
              방식으로 합니다.
            </p>
            <p>
              부족한 기술이나 지식이 있을 때는 관련 강의를 듣고, 토이 프로젝트를
              진행하여 실력을 쌓습니다.
            </p>
            <p>
              또한, 직장 상사나 선배들에게 도움을 요청해 부족한 부분을 보완하고
              있습니다.
            </p>
            <p>
              특히, 새로운 것을 배우는 것을 좋아해서 다양한 프레임워크나 툴을
              사용해보려고 시도하는 편입니다.
            </p>
          </div>
        </div>
