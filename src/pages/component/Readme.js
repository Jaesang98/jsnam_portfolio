...
function Readme({ projectId, closeReadme }) {
    const projectDetail = projectDetails.find(item => item.prDetail_id === projectId);
            ...
            <div className="Readme-container">
                {!imgShow ? (
                    <>
                        ...
                        <p className="Readme-date">진행 날짜: {projectDetail.prDetail_date}</p>

                        <div className="Readme-description">
                            <h3>
                                <img src={Description} alt="Description Icon" className="Readme-icon" />
                                프로젝트 설명
                            </h3>
                            <p>
                                {projectDetail.prDetail_description}
                            </p>
                        </div>

                        <div className="Readme-tech-stack">
                            <h3>
                                <img src={Skill} alt="Tech Stack Icon" className="Readme-icon" />
                                사용한 언어/프레임워크
                            </h3>
                        ...
                        <div className="Readme-features">
                            <h3>
                                <img src={Feature} alt="Features Icon" className="Readme-icon" />
                                주요 기능
                            </h3>
                            <ul>
                                {
                        ...
                        <div className="Readme-role">
                            ...
                            <p>
                                {projectDetail.prDetail_role}
                            </p>
                        </div>

                        <div className="Readme-reflections">
                            <h3>
                                <img src={Feel} alt="Reflections Icon" className="Readme-icon" />
                                느낀 점
                            </h3>
                            <p>
                                {projectDetail.prDetail_reflections}
                            </p>
                        </div>

                        <div className="Readme-image">
                            <h3>
                                <img src={ProjectImage} alt="Image Icon" className="Readme-icon" />
                                프로젝트 이미지
                            </h3>
                                ...
                                >
                                    {projectDetail.prDetail_images.map((image, index) => (
                                        <SwiperSlide key={index}>
                                            <img src={image} alt={`Project Image ${index + 1}`} className="Readme-project-image"
                        ...
                        <div className="Readme-challenges">
                            <h3>
                                <img src={Solution} alt="Challenges Icon" className="Readme-icon" />
                                문제점과 해결 방안
                            </h3>
                            <p>
                                <strong>문제점:</strong> {projectDetail.prDetail_challenges.problem}<br /><br />
                                <strong>해결 방안:</strong> {projectDetail.prDetail_challenges.solution}
                            </p>
                        </div>
                        ...
                        <div className="Readme-outcomes">
                            ...
                            <p>
                                {projectDetail.prDetail_outcomes}
                            </p>
                        </div>
                        ...
                        <div className='Readme-link'>
                            {
                                projectDetail.prDetail_links.projectLink ? (
                                    <a href={projectDetail.prDetail_links.projectLink} target="_blank" className="Readme-demo-link mr10">프로젝트 보기</a>
                                ) : ""
                            }

                            {
                                projectDetail.prDetail_links.githubLink ? (
                                    <a href={projectDetail.prDetail_links.githubLink} target="_blank" className="Readme-demo-link">깃허브 보기</a>
                                ) : ""
                            }
                        </div>
                    </>
